...
use DEPTRAC_202312\PhpParser\Node\Identifier;
use DEPTRAC_202312\PhpParser\Node\Name;
use DEPTRAC_202312\PhpParser\Node\Stmt\Class_;
use DEPTRAC_202312\PhpParser\Node\Stmt\ClassLike;
use DEPTRAC_202312\PhpParser\Node\Stmt\GroupUse;
use DEPTRAC_202312\PhpParser\Node\Stmt\Interface_;
use DEPTRAC_202312\PhpParser\Node\Stmt\Namespace_;
use DEPTRAC_202312\PhpParser\Node\Stmt\Trait_;
use DEPTRAC_202312\PhpParser\Node\Stmt\Use_;
...
use DEPTRAC_202312\PHPStan\PhpDocParser\Parser\PhpDocParser;
