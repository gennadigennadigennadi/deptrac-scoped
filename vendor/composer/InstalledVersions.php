 ...
 */
namespace DEPTRAC_202311\Composer;

use DEPTRAC_202311\Composer\Autoload\ClassLoader;
use DEPTRAC_202311\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    public static function getInstalledPackages()
    {
        ...
        return \array_keys(\array_flip(\call_user_func_array('DEPTRAC_202311\\array_merge', $packages)));
    }
    /**
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('DEPTRAC_202311\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
