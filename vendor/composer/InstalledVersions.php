 ...
 */
namespace DEPTRAC_1700756462\Composer;

use DEPTRAC_1700756462\Composer\Autoload\ClassLoader;
use DEPTRAC_1700756462\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    public static function getInstalledPackages()
    {
        ...
        return \array_keys(\array_flip(\call_user_func_array('DEPTRAC_1700756462\\array_merge', $packages)));
    }
    /**
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('DEPTRAC_1700756462\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
