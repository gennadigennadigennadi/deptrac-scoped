 ...
 */
namespace DEPTRAC_1700753084\Composer\Autoload;
...
class ClassLoader
{
    ...
    public function getPrefixes()
    {
        if (!empty($this->prefixesPsr0)) {
            return \call_user_func_array('DEPTRAC_1700753084\\array_merge', \array_values($this->prefixesPsr0));
        }
        return array();
    }
    /**
    ...
    public function findFile($class)
    {
        ...
        if (\false === $file && \defined('DEPTRAC_1700753084\\HHVM_VERSION')) {
