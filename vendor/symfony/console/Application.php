...
use DEPTRAC_1700756462\Symfony\Component\Console\Command\CompleteCommand;
use DEPTRAC_1700756462\Symfony\Component\Console\Command\DumpCompletionCommand;
use DEPTRAC_1700756462\Symfony\Component\Console\Command\HelpCommand;
use DEPTRAC_1700756462\Symfony\Component\Console\Command\LazyCommand;
use DEPTRAC_1700756462\Symfony\Component\Console\Command\ListCommand;
use DEPTRAC_1700756462\Symfony\Component\Console\Command\SignalableCommandInterface;
use DEPTRAC_1700756462\Symfony\Component\Console\CommandLoader\CommandLoaderInterface;
...
use DEPTRAC_1700756462\Symfony\Component\Console\Completion\Suggestion;
use DEPTRAC_1700756462\Symfony\Component\Console\Event\ConsoleCommandEvent;
use DEPTRAC_1700756462\Symfony\Component\Console\Event\ConsoleErrorEvent;
use DEPTRAC_1700756462\Symfony\Component\Console\Event\ConsoleSignalEvent;
...
use DEPTRAC_1700756462\Symfony\Component\Console\Exception\ExceptionInterface;
use DEPTRAC_1700756462\Symfony\Component\Console\Exception\LogicException;
use DEPTRAC_1700756462\Symfony\Component\Console\Exception\NamespaceNotFoundException;
...
use DEPTRAC_1700756462\Symfony\Component\Console\Helper\DebugFormatterHelper;
use DEPTRAC_1700756462\Symfony\Component\Console\Helper\DescriptorHelper;
use DEPTRAC_1700756462\Symfony\Component\Console\Helper\FormatterHelper;
use DEPTRAC_1700756462\Symfony\Component\Console\Helper\Helper;
use DEPTRAC_1700756462\Symfony\Component\Console\Helper\HelperSet;
use DEPTRAC_1700756462\Symfony\Component\Console\Helper\ProcessHelper;
use DEPTRAC_1700756462\Symfony\Component\Console\Helper\QuestionHelper;
use DEPTRAC_1700756462\Symfony\Component\Console\Input\ArgvInput;
use DEPTRAC_1700756462\Symfony\Component\Console\Input\ArrayInput;
use DEPTRAC_1700756462\Symfony\Component\Console\Input\InputArgument;
use DEPTRAC_1700756462\Symfony\Component\Console\Input\InputAwareInterface;
use DEPTRAC_1700756462\Symfony\Component\Console\Input\InputDefinition;
use DEPTRAC_1700756462\Symfony\Component\Console\Input\InputInterface;
use DEPTRAC_1700756462\Symfony\Component\Console\Input\InputOption;
use DEPTRAC_1700756462\Symfony\Component\Console\Output\ConsoleOutput;
...
use DEPTRAC_1700756462\Symfony\Component\Console\SignalRegistry\SignalRegistry;
use DEPTRAC_1700756462\Symfony\Component\Console\Style\SymfonyStyle;
use DEPTRAC_1700756462\Symfony\Component\ErrorHandler\ErrorHandler;
use DEPTRAC_1700756462\Symfony\Contracts\EventDispatcher\EventDispatcherInterface;
                ...
                foreach ($this->signalsToDispatchEvent as $signal) {
                    ...
                    $this->signalRegistry->register($signal, function ($signal) use($event, $command, $commandSignals) {
                        ...
                        if (\in_array($signal, $commandSignals, \true)) {
                            ...
                            if (null === $exitCode) {
                                \DEPTRAC_1700756462\trigger_deprecation('symfony/console', '6.3', 'Not returning an exit code from "%s::handleSignal()" is deprecated, return "false" to keep the command running or "0" to exit successfully.', \get_debug_type($command));
                                $exitCode = 0;
                            }
                        }
                        if (\false !== $exitCode) {
