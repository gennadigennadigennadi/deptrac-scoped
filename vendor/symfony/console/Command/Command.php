 ...
 */
namespace DEPTRAC_1700753084\Symfony\Component\Console\Command;

use DEPTRAC_1700753084\Symfony\Component\Console\Application;
use DEPTRAC_1700753084\Symfony\Component\Console\Attribute\AsCommand;
...
use DEPTRAC_1700753084\Symfony\Component\Console\Helper\HelperInterface;
...
class Command
{
    ...
    public static function getDefaultName() : ?string
    {
        ...
        \DEPTRAC_1700753084\trigger_deprecation('symfony/console', '6.1', 'Relying on the static property "$defaultName" for setting a command name is deprecated. Add the "%s" attribute to the "%s" class instead.', AsCommand::class, static::class);
    ...
    public static function getDefaultDescription() : ?string
    {
        ...
        \DEPTRAC_1700753084\trigger_deprecation('symfony/console', '6.1', 'Relying on the static property "$defaultDescription" for setting a command description is deprecated. Add the "%s" attribute to the "%s" class instead.', AsCommand::class, static::class);
    ...
    {
        if (1 > \func_num_args()) {
            \DEPTRAC_1700753084\trigger_deprecation('symfony/console', '6.2', 'Calling "%s()" without any arguments is deprecated, pass null explicitly instead.', __METHOD__);
        }
