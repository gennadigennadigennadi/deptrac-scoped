 ...
 */
namespace DEPTRAC_202312\Symfony\Component\Console\Command;

use DEPTRAC_202312\Symfony\Component\Console\Application;
use DEPTRAC_202312\Symfony\Component\Console\Attribute\AsCommand;
...
use DEPTRAC_202312\Symfony\Component\Console\Helper\HelperInterface;
...
class Command
{
    ...
    public static function getDefaultName() : ?string
    {
        ...
        \DEPTRAC_202312\trigger_deprecation('symfony/console', '6.1', 'Relying on the static property "$defaultName" for setting a command name is deprecated. Add the "%s" attribute to the "%s" class instead.', AsCommand::class, static::class);
    ...
    public static function getDefaultDescription() : ?string
    {
        ...
        \DEPTRAC_202312\trigger_deprecation('symfony/console', '6.1', 'Relying on the static property "$defaultDescription" for setting a command description is deprecated. Add the "%s" attribute to the "%s" class instead.', AsCommand::class, static::class);
