 ...
 */
namespace DEPTRAC_202311\Symfony\Component\Config\Builder;
...
use DEPTRAC_202311\Symfony\Component\Config\Definition\BooleanNode;
use DEPTRAC_202311\Symfony\Component\Config\Definition\Builder\ExprBuilder;
...
use DEPTRAC_202311\Symfony\Component\Config\Definition\Exception\InvalidConfigurationException;
use DEPTRAC_202311\Symfony\Component\Config\Definition\FloatNode;
use DEPTRAC_202311\Symfony\Component\Config\Definition\IntegerNode;
...
use DEPTRAC_202311\Symfony\Component\Config\Loader\ParamConfigurator;
/**
...
class ConfigBuilderGenerator implements ConfigBuilderGeneratorInterface
{
    ...
    public function build(ConfigurationInterface $configuration) : \Closure
    {
        ...
        $rootClass = new ClassBuilder('DEPTRAC_202311\\Symfony\\Config', $rootNode->getName());
