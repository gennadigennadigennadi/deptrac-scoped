...
use DEPTRAC_202312\Composer\InstalledVersions;
use DEPTRAC_202312\Symfony\Component\Config\Resource\ClassExistenceResource;
use DEPTRAC_202312\Symfony\Component\Config\Resource\ComposerResource;
use DEPTRAC_202312\Symfony\Component\Config\Resource\DirectoryResource;
use DEPTRAC_202312\Symfony\Component\Config\Resource\FileExistenceResource;
...
use DEPTRAC_202312\Symfony\Component\Config\Resource\ReflectionClassResource;
use DEPTRAC_202312\Symfony\Component\Config\Resource\ResourceInterface;
...
use DEPTRAC_202312\Symfony\Component\DependencyInjection\Compiler\Compiler;
use DEPTRAC_202312\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface;
use DEPTRAC_202312\Symfony\Component\DependencyInjection\Compiler\PassConfig;
use DEPTRAC_202312\Symfony\Component\DependencyInjection\Compiler\ResolveEnvPlaceholdersPass;
use DEPTRAC_202312\Symfony\Component\DependencyInjection\Exception\BadMethodCallException;
...
use DEPTRAC_202312\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException;
use DEPTRAC_202312\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException;
use DEPTRAC_202312\Symfony\Component\DependencyInjection\Extension\ExtensionInterface;
use DEPTRAC_202312\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\InstantiatorInterface;
use DEPTRAC_202312\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\LazyServiceInstantiator;
use DEPTRAC_202312\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\RealServiceInstantiator;
use DEPTRAC_202312\Symfony\Component\DependencyInjection\ParameterBag\EnvPlaceholderParameterBag;
...
use DEPTRAC_202312\Symfony\Component\ExpressionLanguage\ExpressionFunctionProviderInterface;
/**
    ...
    private function doGet(string $id, int $invalidBehavior = ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE, array &$inlineServices = null, bool $isConstructorArgument = \false) : mixed
    {
        ...
        if (!isset($this->definitions[$id]) && isset($this->aliasDefinitions[$id])) {
            ...
            if ($alias->isDeprecated()) {
                ...
                \DEPTRAC_202312\trigger_deprecation($deprecation['package'], $deprecation['version'], $deprecation['message']);
            }
        ...
        if (null !== $factory) {
            ...
            if (!$definition->isDeprecated() && \is_array($factory) && \is_string($factory[0])) {
                ...
                if (0 < \strpos($r->getDocComment(), "\n * @deprecated ")) {
                    \DEPTRAC_202312\trigger_deprecation('', '', 'The "%s" service relies on the deprecated "%s" factory class. It should either be deprecated or its factory upgraded.', $id, $r->name);
                }
            }
        } else {
            ...
            if (!$definition->isDeprecated() && 0 < \strpos($r->getDocComment(), "\n * @deprecated ")) {
                \DEPTRAC_202312\trigger_deprecation('', '', 'The "%s" service relies on the deprecated "%s" class. It should either be deprecated or its implementation upgraded.', $id, $r->name);
            }
        }
