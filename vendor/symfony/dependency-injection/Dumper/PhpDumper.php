 ...
 */
namespace DEPTRAC_1700753084\Symfony\Component\DependencyInjection\Dumper;

use DEPTRAC_1700753084\Composer\Autoload\ClassLoader;
use DEPTRAC_1700753084\Symfony\Component\Config\Resource\FileResource;
use DEPTRAC_1700753084\Symfony\Component\DependencyInjection\Argument\AbstractArgument;
use DEPTRAC_1700753084\Symfony\Component\DependencyInjection\Argument\ArgumentInterface;
use DEPTRAC_1700753084\Symfony\Component\DependencyInjection\Argument\IteratorArgument;
use DEPTRAC_1700753084\Symfony\Component\DependencyInjection\Argument\LazyClosure;
use DEPTRAC_1700753084\Symfony\Component\DependencyInjection\Argument\ServiceClosureArgument;
use DEPTRAC_1700753084\Symfony\Component\DependencyInjection\Argument\ServiceLocator;
use DEPTRAC_1700753084\Symfony\Component\DependencyInjection\Argument\ServiceLocatorArgument;
use DEPTRAC_1700753084\Symfony\Component\DependencyInjection\Compiler\AnalyzeServiceReferencesPass;
use DEPTRAC_1700753084\Symfony\Component\DependencyInjection\Compiler\CheckCircularReferencesPass;
use DEPTRAC_1700753084\Symfony\Component\DependencyInjection\Compiler\ServiceReferenceGraphNode;
use DEPTRAC_1700753084\Symfony\Component\DependencyInjection\Container;
use DEPTRAC_1700753084\Symfony\Component\DependencyInjection\ContainerBuilder;
use DEPTRAC_1700753084\Symfony\Component\DependencyInjection\ContainerInterface;
use DEPTRAC_1700753084\Symfony\Component\DependencyInjection\Definition;
use DEPTRAC_1700753084\Symfony\Component\DependencyInjection\Exception\EnvParameterException;
...
use DEPTRAC_1700753084\Symfony\Component\DependencyInjection\ExpressionLanguage;
use DEPTRAC_1700753084\Symfony\Component\DependencyInjection\LazyProxy\PhpDumper\DumperInterface;
use DEPTRAC_1700753084\Symfony\Component\DependencyInjection\LazyProxy\PhpDumper\LazyServiceDumper;
use DEPTRAC_1700753084\Symfony\Component\DependencyInjection\LazyProxy\PhpDumper\NullDumper;
use DEPTRAC_1700753084\Symfony\Component\DependencyInjection\Loader\FileLoader;
use DEPTRAC_1700753084\Symfony\Component\DependencyInjection\Parameter;
use DEPTRAC_1700753084\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag;
use DEPTRAC_1700753084\Symfony\Component\DependencyInjection\Reference;
use DEPTRAC_1700753084\Symfony\Component\DependencyInjection\ServiceLocator as BaseServiceLocator;
use DEPTRAC_1700753084\Symfony\Component\DependencyInjection\TypedReference;
use DEPTRAC_1700753084\Symfony\Component\DependencyInjection\Variable;
use DEPTRAC_1700753084\Symfony\Component\ErrorHandler\DebugClassLoader;
use DEPTRAC_1700753084\Symfony\Component\ExpressionLanguage\Expression;
use DEPTRAC_1700753084\Symfony\Component\HttpKernel\Kernel;
/**
...
class PhpDumper extends Dumper
{
    ...
    public function dump(array $options = []) : string|array
    {
        ...
        if (isset($options['inline_factories'])) {
            ...
            \DEPTRAC_1700753084\trigger_deprecation('symfony/dependency-injection', '6.3', 'Option "inline_factories_parameter" passed to "%s()" is deprecated, use option "inline_factories" instead.', __METHOD__);
        ...
        if (isset($options['inline_class_loader'])) {
            ...
            \DEPTRAC_1700753084\trigger_deprecation('symfony/dependency-injection', '6.3', 'Option "inline_class_loader_parameter" passed to "%s()" is deprecated, use option "inline_class_loader" instead.', __METHOD__);
...
use DEPTRAC_1700753084\\Symfony\\Component\\DependencyInjection\\Argument\\RewindableGenerator;
use DEPTRAC_1700753084\\Symfony\\Component\\DependencyInjection\\Exception\\RuntimeException;
...
use DEPTRAC_1700753084\\Symfony\\Component\\DependencyInjection\\Dumper\\Preloader;
...
, $this->container->getDefinition($id)->isPublic() ? 'services' : 'privates', $this->doExport($id));
    ...
    private function addNewInstance(Definition $definition, string $return = '', string $id = null, bool $asGhostObject = \false) : string
    {
        ...
        if (null !== $definition->getFactory()) {
            ...
            if (['...'] === $arguments && ($definition->isLazy() || 'Closure' !== ($definition->getClass() ?? 'Closure')) && ($callable[0] instanceof Reference || $callable[0] instanceof Definition && !$this->definitionVariables->contains($callable[0]))) {
...
use DEPTRAC_1700753084\\Symfony\\Component\\DependencyInjection\\Container;
use DEPTRAC_1700753084\\Symfony\\Component\\DependencyInjection\\Exception\\LogicException;
use DEPTRAC_1700753084\\Symfony\\Component\\DependencyInjection\\Exception\\ParameterNotFoundException;
use DEPTRAC_1700753084\\Symfony\\Component\\DependencyInjection\\Exception\\RuntimeException;
use DEPTRAC_1700753084\\Symfony\\Component\\DependencyInjection\\ParameterBag\\FrozenParameterBag;
use DEPTRAC_1700753084\\Symfony\\Component\\DependencyInjection\\ParameterBag\\ParameterBagInterface;
...
EOF;
    ...
    private function getExpressionLanguage() : ExpressionLanguage
    {
        if (!isset($this->expressionLanguage)) {
            if (!\class_exists(\DEPTRAC_1700753084\Symfony\Component\ExpressionLanguage\ExpressionLanguage::class)) {
