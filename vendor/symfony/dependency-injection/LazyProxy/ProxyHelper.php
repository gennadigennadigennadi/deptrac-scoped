 ...
 */
namespace DEPTRAC_1700756462\Symfony\Component\DependencyInjection\LazyProxy;

\DEPTRAC_1700756462\trigger_deprecation('symfony/dependency-injection', '6.2', 'The "%s" class is deprecated, use "%s" instead.', ProxyHelper::class, \DEPTRAC_1700756462\Symfony\Component\VarExporter\ProxyHelper::class);
/**
