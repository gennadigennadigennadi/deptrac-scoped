 ...
 */
namespace DEPTRAC_202311\Symfony\Contracts\Service\Test;

use DEPTRAC_202311\PHPUnit\Framework\TestCase;
use DEPTRAC_202311\Psr\Container\ContainerInterface;
use DEPTRAC_202311\Symfony\Contracts\Service\ServiceLocatorTrait;
abstract class ServiceLocatorTestCase extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\DEPTRAC_202311\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\DEPTRAC_202311\Psr\Container\ContainerExceptionInterface::class);
