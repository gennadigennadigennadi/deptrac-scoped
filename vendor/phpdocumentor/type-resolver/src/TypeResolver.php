...
use DEPTRAC_1700756462\phpDocumentor\Reflection\PseudoTypes\ArrayShape;
use DEPTRAC_1700756462\phpDocumentor\Reflection\PseudoTypes\ArrayShapeItem;
use DEPTRAC_1700756462\phpDocumentor\Reflection\PseudoTypes\CallableString;
use DEPTRAC_1700756462\phpDocumentor\Reflection\PseudoTypes\ConstExpression;
use DEPTRAC_1700756462\phpDocumentor\Reflection\PseudoTypes\False_;
use DEPTRAC_1700756462\phpDocumentor\Reflection\PseudoTypes\FloatValue;
use DEPTRAC_1700756462\phpDocumentor\Reflection\PseudoTypes\HtmlEscapedString;
use DEPTRAC_1700756462\phpDocumentor\Reflection\PseudoTypes\IntegerRange;
use DEPTRAC_1700756462\phpDocumentor\Reflection\PseudoTypes\IntegerValue;
use DEPTRAC_1700756462\phpDocumentor\Reflection\PseudoTypes\List_;
use DEPTRAC_1700756462\phpDocumentor\Reflection\PseudoTypes\LiteralString;
use DEPTRAC_1700756462\phpDocumentor\Reflection\PseudoTypes\LowercaseString;
use DEPTRAC_1700756462\phpDocumentor\Reflection\PseudoTypes\NegativeInteger;
use DEPTRAC_1700756462\phpDocumentor\Reflection\PseudoTypes\NonEmptyList;
use DEPTRAC_1700756462\phpDocumentor\Reflection\PseudoTypes\NonEmptyLowercaseString;
use DEPTRAC_1700756462\phpDocumentor\Reflection\PseudoTypes\NonEmptyString;
use DEPTRAC_1700756462\phpDocumentor\Reflection\PseudoTypes\Numeric_;
use DEPTRAC_1700756462\phpDocumentor\Reflection\PseudoTypes\NumericString;
use DEPTRAC_1700756462\phpDocumentor\Reflection\PseudoTypes\PositiveInteger;
use DEPTRAC_1700756462\phpDocumentor\Reflection\PseudoTypes\StringValue;
use DEPTRAC_1700756462\phpDocumentor\Reflection\PseudoTypes\TraitString;
use DEPTRAC_1700756462\phpDocumentor\Reflection\PseudoTypes\True_;
use DEPTRAC_1700756462\phpDocumentor\Reflection\Types\AggregatedType;
...
use DEPTRAC_1700756462\phpDocumentor\Reflection\Types\Boolean;
use DEPTRAC_1700756462\phpDocumentor\Reflection\Types\Callable_;
use DEPTRAC_1700756462\phpDocumentor\Reflection\Types\CallableParameter;
use DEPTRAC_1700756462\phpDocumentor\Reflection\Types\ClassString;
use DEPTRAC_1700756462\phpDocumentor\Reflection\Types\Collection;
...
use DEPTRAC_1700756462\phpDocumentor\Reflection\Types\Expression;
use DEPTRAC_1700756462\phpDocumentor\Reflection\Types\Float_;
use DEPTRAC_1700756462\phpDocumentor\Reflection\Types\Integer;
use DEPTRAC_1700756462\phpDocumentor\Reflection\Types\InterfaceString;
use DEPTRAC_1700756462\phpDocumentor\Reflection\Types\Intersection;
use DEPTRAC_1700756462\phpDocumentor\Reflection\Types\Iterable_;
use DEPTRAC_1700756462\phpDocumentor\Reflection\Types\Mixed_;
use DEPTRAC_1700756462\phpDocumentor\Reflection\Types\Never_;
use DEPTRAC_1700756462\phpDocumentor\Reflection\Types\Null_;
use DEPTRAC_1700756462\phpDocumentor\Reflection\Types\Nullable;
use DEPTRAC_1700756462\phpDocumentor\Reflection\Types\Object_;
use DEPTRAC_1700756462\phpDocumentor\Reflection\Types\Parent_;
use DEPTRAC_1700756462\phpDocumentor\Reflection\Types\Resource_;
use DEPTRAC_1700756462\phpDocumentor\Reflection\Types\Scalar;
use DEPTRAC_1700756462\phpDocumentor\Reflection\Types\Self_;
use DEPTRAC_1700756462\phpDocumentor\Reflection\Types\Static_;
use DEPTRAC_1700756462\phpDocumentor\Reflection\Types\String_;
use DEPTRAC_1700756462\phpDocumentor\Reflection\Types\This;
use DEPTRAC_1700756462\phpDocumentor\Reflection\Types\Void_;
use DEPTRAC_1700756462\PHPStan\PhpDocParser\Ast\ConstExpr\ConstExprFloatNode;
use DEPTRAC_1700756462\PHPStan\PhpDocParser\Ast\ConstExpr\ConstExprIntegerNode;
use DEPTRAC_1700756462\PHPStan\PhpDocParser\Ast\ConstExpr\ConstExprStringNode;
use DEPTRAC_1700756462\PHPStan\PhpDocParser\Ast\ConstExpr\ConstFetchNode;
use DEPTRAC_1700756462\PHPStan\PhpDocParser\Ast\Type\ArrayShapeItemNode;
use DEPTRAC_1700756462\PHPStan\PhpDocParser\Ast\Type\ArrayShapeNode;
use DEPTRAC_1700756462\PHPStan\PhpDocParser\Ast\Type\ArrayTypeNode;
use DEPTRAC_1700756462\PHPStan\PhpDocParser\Ast\Type\CallableTypeNode;
use DEPTRAC_1700756462\PHPStan\PhpDocParser\Ast\Type\CallableTypeParameterNode;
use DEPTRAC_1700756462\PHPStan\PhpDocParser\Ast\Type\ConditionalTypeForParameterNode;
use DEPTRAC_1700756462\PHPStan\PhpDocParser\Ast\Type\ConditionalTypeNode;
use DEPTRAC_1700756462\PHPStan\PhpDocParser\Ast\Type\ConstTypeNode;
use DEPTRAC_1700756462\PHPStan\PhpDocParser\Ast\Type\GenericTypeNode;
use DEPTRAC_1700756462\PHPStan\PhpDocParser\Ast\Type\IdentifierTypeNode;
use DEPTRAC_1700756462\PHPStan\PhpDocParser\Ast\Type\IntersectionTypeNode;
use DEPTRAC_1700756462\PHPStan\PhpDocParser\Ast\Type\NullableTypeNode;
use DEPTRAC_1700756462\PHPStan\PhpDocParser\Ast\Type\OffsetAccessTypeNode;
use DEPTRAC_1700756462\PHPStan\PhpDocParser\Ast\Type\ThisTypeNode;
use DEPTRAC_1700756462\PHPStan\PhpDocParser\Ast\Type\TypeNode;
use DEPTRAC_1700756462\PHPStan\PhpDocParser\Ast\Type\UnionTypeNode;
use DEPTRAC_1700756462\PHPStan\PhpDocParser\Lexer\Lexer;
use DEPTRAC_1700756462\PHPStan\PhpDocParser\Parser\ConstExprParser;
use DEPTRAC_1700756462\PHPStan\PhpDocParser\Parser\ParserException;
use DEPTRAC_1700756462\PHPStan\PhpDocParser\Parser\TokenIterator;
use DEPTRAC_1700756462\PHPStan\PhpDocParser\Parser\TypeParser;
