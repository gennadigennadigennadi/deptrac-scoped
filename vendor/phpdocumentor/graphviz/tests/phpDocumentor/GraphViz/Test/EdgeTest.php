...
class EdgeTest extends TestCase
{
    ...
    public function testConstruct() : void
    {
        ...
        $this->assertInstanceOf(Edge::class, $fixture);
        $this->assertSame($fromNode, $fixture->getFrom());
        $this->assertSame($toNode, $fixture->getTo());
    }
    /**
    ...
    {
        $this->assertInstanceOf(Edge::class, Edge::create(new Node('from'), new Node('to')));
    }
    /**
