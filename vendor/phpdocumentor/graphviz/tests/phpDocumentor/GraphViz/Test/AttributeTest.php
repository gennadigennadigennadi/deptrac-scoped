...
class AttributeTest extends TestCase
{
    ...
    public function testConstruct() : void
    {
        ...
        $this->assertInstanceOf(Attribute::class, $fixture);
    ...
    public function testIsValueInHtml() : void
    {
        ...
        $this->assertFalse($this->fixture->isValueInHtml(), 'Expected value to not be a HTML code');
        $this->fixture->setValue('<a>test</a>');
        $this->assertTrue($this->fixture->isValueInHtml(), 'Expected value to be recognized as a HTML code');
    }
    /**
    ...
    public function testToStringWithSpecials() : void
    {
        ...
        $this->fixture->setValue('a\\\\l"a');
        $this->assertSame('a="a\\\\l\\"a"', (string) $this->fixture, 'Double backslashes should stay the same');
    }
    /**
