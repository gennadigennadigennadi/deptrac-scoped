...
class GraphTest extends TestCase
{
    ...
    public function testCreate() : void
    {
        ...
        $this->assertInstanceOf(Graph::class, $fixture);
        $this->assertSame('G', $fixture->getName());
        $this->assertSame('digraph', $fixture->getType());
        $fixture = Graph::create('MyName', \false);
        $this->assertSame('MyName', $fixture->getName());
        $this->assertSame('graph', $fixture->getType());
    }
    /**
    ...
    {
        $this->assertSame($this->fixture, $this->fixture->setType('digraph'), 'Expecting a fluent interface');
        $this->assertSame($this->fixture, $this->fixture->setType('graph'), 'Expecting a fluent interface');
        $this->assertSame($this->fixture, $this->fixture->setType('subgraph'), 'Expecting a fluent interface');
    }
    /**
     * @covers \phpDocumentor\GraphViz\Graph::setType
     */
    ...
    {
        $this->assertSame($this->fixture, $this->fixture->setStrict(\true), 'Expecting a fluent interface');
        $this->assertSame($this->fixture, $this->fixture->setStrict(\false), 'Expecting a fluent interface');
    }
    public function testIsStrict() : void
    {
        $this->assertSame($this->fixture->isStrict(), \false);
        $this->fixture->setStrict(\true);
        $this->assertSame($this->fixture->isStrict(), \true);
    }
    ...
    public function testAddGraph() : void
    {
        ...
        $this->assertSame($this->fixture, $this->fixture->addGraph($mock));
    }
    /**
    ...
    public function testSetNode() : void
    {
        ...
        $mock->expects('getName')->andReturn('MyName');
        $this->assertSame($this->fixture, $this->fixture->setNode($mock));
    }
    /**
    ...
    public function test__get() : void
    {
        ...
        $this->assertSame($mock, $this->fixture->myNode);
    }
    /**
    ...
    public function testExport() : void
    {
        ...
        $this->assertSame($graph, $graph->export('pdf', $filename));
    ...
    {
        $graph = Graph::create('My First Graph');
        $this->assertSame($this->normalizeLineEndings((string) $graph), $this->normalizeLineEndings('digraph "My First Graph" {' . PHP_EOL . PHP_EOL . '}'));
        $graph->setLabel('PigeonPost');
        $this->assertSame($this->normalizeLineEndings((string) $graph), $this->normalizeLineEndings('digraph "My First Graph" {' . PHP_EOL . 'label="PigeonPost"' . PHP_EOL . '}'));
        $graph->setStrict(\true);
        $this->assertSame($this->normalizeLineEndings((string) $graph), $this->normalizeLineEndings('strict digraph "My First Graph" {' . PHP_EOL . 'label="PigeonPost"' . PHP_EOL . '}'));
    }
    /**
