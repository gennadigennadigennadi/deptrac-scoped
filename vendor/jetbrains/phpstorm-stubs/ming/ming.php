...
// Start of ming v.
\class_alias('DEPTRAC_202312\\SWFShape', 'SWFShape', \false);
class SWFFill
{
    public function __construct()
    {
...
\class_alias('DEPTRAC_202312\\SWFFill', 'SWFFill', \false);
class SWFGradient
{
    public function __construct()
    {
...
\class_alias('DEPTRAC_202312\\SWFGradient', 'SWFGradient', \false);
class SWFBitmap
{
    public function __construct()
    {
...
\class_alias('DEPTRAC_202312\\SWFBitmap', 'SWFBitmap', \false);
class SWFText
{
    public function __construct()
    {
...
\class_alias('DEPTRAC_202312\\SWFText', 'SWFText', \false);
class SWFTextField
{
    public function __construct()
    {
...
\class_alias('DEPTRAC_202312\\SWFTextField', 'SWFTextField', \false);
class SWFFont
{
    public function __construct()
    {
...
\class_alias('DEPTRAC_202312\\SWFFont', 'SWFFont', \false);
...
\class_alias('DEPTRAC_202312\\SWFDisplayItem', 'SWFDisplayItem', \false);
class SWFMovie
{
    public function __construct()
    {
...
\class_alias('DEPTRAC_202312\\SWFMovie', 'SWFMovie', \false);
class SWFButton
{
    public function __construct()
    {
...
\class_alias('DEPTRAC_202312\\SWFButton', 'SWFButton', \false);
class SWFAction
{
    public function __construct()
    {
...
\class_alias('DEPTRAC_202312\\SWFAction', 'SWFAction', \false);
class SWFMorph
{
    public function __construct()
    {
...
\class_alias('DEPTRAC_202312\\SWFMorph', 'SWFMorph', \false);
class SWFSprite
{
    public function __construct()
    {
...
\class_alias('DEPTRAC_202312\\SWFSprite', 'SWFSprite', \false);
class SWFSound
{
    public function __construct()
    {
...
\class_alias('DEPTRAC_202312\\SWFSound', 'SWFSound', \false);
class SWFFontChar
{
    public function addChars()
    {
...
\class_alias('DEPTRAC_202312\\SWFFontChar', 'SWFFontChar', \false);
...
\class_alias('DEPTRAC_202312\\SWFSoundInstance', 'SWFSoundInstance', \false);
...
\class_alias('DEPTRAC_202312\\SWFVideoStream', 'SWFVideoStream', \false);
/**
 * Set cubic threshold
