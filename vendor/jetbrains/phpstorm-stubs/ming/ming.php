...
// Start of ming v.
\class_alias('DEPTRAC_202311\\SWFShape', 'SWFShape', \false);
class SWFFill
{
    public function __construct()
    {
...
\class_alias('DEPTRAC_202311\\SWFFill', 'SWFFill', \false);
class SWFGradient
{
    public function __construct()
    {
...
\class_alias('DEPTRAC_202311\\SWFGradient', 'SWFGradient', \false);
class SWFBitmap
{
    public function __construct()
    {
...
\class_alias('DEPTRAC_202311\\SWFBitmap', 'SWFBitmap', \false);
class SWFText
{
    public function __construct()
    {
...
\class_alias('DEPTRAC_202311\\SWFText', 'SWFText', \false);
class SWFTextField
{
    public function __construct()
    {
...
\class_alias('DEPTRAC_202311\\SWFTextField', 'SWFTextField', \false);
class SWFFont
{
    public function __construct()
    {
...
\class_alias('DEPTRAC_202311\\SWFFont', 'SWFFont', \false);
...
\class_alias('DEPTRAC_202311\\SWFDisplayItem', 'SWFDisplayItem', \false);
class SWFMovie
{
    public function __construct()
    {
...
\class_alias('DEPTRAC_202311\\SWFMovie', 'SWFMovie', \false);
class SWFButton
{
    public function __construct()
    {
...
\class_alias('DEPTRAC_202311\\SWFButton', 'SWFButton', \false);
class SWFAction
{
    public function __construct()
    {
...
\class_alias('DEPTRAC_202311\\SWFAction', 'SWFAction', \false);
class SWFMorph
{
    public function __construct()
    {
...
\class_alias('DEPTRAC_202311\\SWFMorph', 'SWFMorph', \false);
class SWFSprite
{
    public function __construct()
    {
...
\class_alias('DEPTRAC_202311\\SWFSprite', 'SWFSprite', \false);
class SWFSound
{
    public function __construct()
    {
...
\class_alias('DEPTRAC_202311\\SWFSound', 'SWFSound', \false);
class SWFFontChar
{
    public function addChars()
    {
...
\class_alias('DEPTRAC_202311\\SWFFontChar', 'SWFFontChar', \false);
...
\class_alias('DEPTRAC_202311\\SWFSoundInstance', 'SWFSoundInstance', \false);
...
\class_alias('DEPTRAC_202311\\SWFVideoStream', 'SWFVideoStream', \false);
/**
 * Set cubic threshold
